<form role="search" method="get" class="c-search-form search-form" action="<?php echo esc_url(home_url('/')); ?>">
    <label class="c-search-form__label">
        <span class="screen-reader-text"><?php esc_html_e('Search for:' , 'knowpress'); ?></span>
        <input type="search" class="c-search-form__label__field search-field" placeholder="<?php esc_attr_e('Search …', 'knowpress') ?>" value="<?php echo get_search_query(); ?>" name="s">
    </label>
    <button aria-label="<?php esc_attr_e('Submit', 'knowpress'); ?>" class="c-search-form__submit js-search-form-btn" type="submit">
